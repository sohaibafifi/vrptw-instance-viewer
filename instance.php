...
<?php
        ...
        while(!feof($myInstanceFile)) {
	      ...
	      if($id == 0) echo "   	  		data.addRow([$x,$y,'Depot',null,null]);\n";
	      else         echo "   	  		data.addRow([$x,null,null,$y,'Customer:$id']);\n";
...
?>    
	      ...
	      var selection = chart.getSelection();
		    ...
		    $( "#dialog" ).html("</p><p>x = " + data.getValue(selection[i].row, 0) + " y = " + data.getValue(selection[i].row, 3) + "</p>"
